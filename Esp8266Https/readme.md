**The reason I wrote this readme is the diffuclty to understand why my secured node.js local server was refused by the Esp8266** The exemple is working only if your IP address is 192.168.1.12. If not
